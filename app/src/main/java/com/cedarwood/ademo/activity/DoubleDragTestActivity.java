 ...
 */
public class DoubleDragTestActivity extends BaseActivity {


    private static final String TAG = DoubleDragTestActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_double_drag);
    ...
    private void initView() {
        ...
        mHeader = (OverOpenScrollView) findViewById(R.id.double_drag_header);
