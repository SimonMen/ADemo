...
public class MainActivity extends BaseActivity {
    ...
    private String[] names = {"TabBarTestActivity","TabBarViewPagerTestActivity", "PullListViewTestActivity", "SwipeRefreshTestActivity", "DragMapTestActivity", "PickerTestActivity",
            "CameraTestActivity", "CheeseTestActivity", "RecyclerAnimatorsTestActivity", "TouchTestActivity", "梦如路长", "虫儿飞!!", "人生", "虫儿飞##", "路长", "虫儿飞$$", "虫儿飞",
            "人生路", "虫儿飞~~", "虫儿飞", "人生路", "虫儿飞~~", "虫儿飞", "人生路", "虫儿飞~~", "虫儿飞", "人生路", "虫儿飞~~"};

    private Class[] classNames={ TabBarTestActivity.class,TabBarViewPagerTestActivity.class,PullListViewTestActivity.class,SwipeRefreshTestActivity.class,DragMapTestActivity.class,
            PickerTestActivity.class,CameraTestActivity.class,CheeseTestActivity.class,RecyclerAnimatorsTestActivity.class,TouchTestActivity.class};
