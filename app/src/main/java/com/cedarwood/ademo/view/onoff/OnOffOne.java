 ...
 */
public class OnOffOne extends LinearLayout{


    private static final String TAG = OnOffOne.class.getSimpleName();
    ...
    public OnOffOne(Context context) {
        this(context,null);

    }

    public OnOffOne(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        bgStrokeWidth = getResources().getDimensionPixelSize(R.dimen.dimen_global_line_h);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if(maxLeftMargin == 0){
            ...
            int cornerR = height/2;
            setBackgroundDrawable(getBgDrawable(width,height,cornerR));
            setPadding(padding,padding,padding,padding);

            imgWidth = (height-padding*2);
            LinearLayout.LayoutParams params = (LayoutParams) dotImg.getLayoutParams();
...
//        Log.i(TAG,"getImgDrawable cRed : " +cRed+" cGreen : "+cGreen+" cBlue : "+cBlue);
    ...
    private Drawable getBgDrawable(int width,int height,int radius){


        GradientDrawable drawable = new GradientDrawable();
        drawable.setColor(bgColor);
        drawable.setStroke(bgStrokeWidth,bgStrokeColor);
